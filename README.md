...
***Important:*** Thanks to Dr Peter Kamphuis, the code can now be installed through `pip`. Please check the repository maintained by Peter for the updated pipeline: [repo](https://github.com/PeterKamphuis/deblend_sofia_detections/tree/main)
